...
export default function RecentJokes({ jokes }: { jokes: Joke[] }) {
  ...
  if (!jokes || jokes.length === 0) {
    return (
      <section id="recent-jokes" className="mb-8 w-full">
        <h2 className="text-2xl font-semibold mb-4 text-center">Recent Jokes</h2>
        <p className="text-center">No jokes viewed yet. Start exploring!</p>
      </section>
    )
  }
